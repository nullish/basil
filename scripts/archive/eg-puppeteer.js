    ...
    let hotelData = await page.evaluate(() => {
        ...
        hotelsElms.forEach((hotelelement) => {
            ...
            try {
                ...
                hotelJson.reviews = hotelelement.querySelector('.bui-review-score__badge').innerText;
                if(hotelelement.querySelector('.bui-price-display__value')){
                    hotelJson.price = hotelelement.querySelector('.bui-price-display__value').innerText;
                }
            }
            catch (exception){
